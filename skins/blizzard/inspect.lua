...
pfUI:RegisterSkin("Inspect", "tbc", function ()
  ...
  HookAddonOrVariable("Blizzard_InspectUI", function()
    ...
    do -- Character Tab
      ...
      if InspectModelRotateLeftButton then InspectModelRotateLeftButton:Hide() end
      if InspectModelRotateRightButton then InspectModelRotateRightButton:Hide() end
